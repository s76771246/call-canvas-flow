...
export const CallInterface = () => {
  ...
  // Hardcoded values - token will be generated by backend
  const phoneNumber = '+919759206343';
  const [callDuration, setCallDuration] = useState(0);
  
  // Mock JWT token - replace this with actual backend-generated token
  const getJWTToken = () => {
    // This should be replaced with an API call to your backend
    // For now, using a placeholder that should be replaced with your backend logic
    return "your_backend_generated_jwt_token_here";
  };
  ...
  const handleConnectClick = () => {
    ...
    // Get token from backend and make call
